...
assert.match(richText.source, /text-runs: \[text-run\("RED", "Geist", 16, 700, false, true, false, 0, 1\.25, #ff0000\), text-run\(" blue", "Geist", 14, 400, true, false, false, 0\.5, 1\.4, #0000ff\)\];/);
